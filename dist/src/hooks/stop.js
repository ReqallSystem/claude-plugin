 ...
 */
import { clearMarker, intervalEnv, projectName, readMarker, readStdin, throttle, } from './common.js';
...
if (!input.stop_hook_active) {
    ...
    const reason = `[reqall] Before completing this turn, invoke the reqall:persist skill to ` +
